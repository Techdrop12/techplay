// src/lib/ai-tools.ts
// @deprecated Non importé. Préférer @/lib/openai.ts ou brancher si besoin.
...
function offlineSummary(text: string, locale = 'fr'): string {
...
export async function generateProductSummary(text: string, locale = 'fr'): Promise<string> {
...
export async function suggestProductIdeas(theme: string, locale = 'fr'): Promise<string> {
  if (!hasKey) {
    return [
