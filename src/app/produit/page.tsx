...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Nos produits – TechPlay',
    description: 'Parcourez notre catalogue TechPlay.',
    type: 'website',
    url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://techplay.example.com'}/produit`,
  },
  twitter: {
...
type PageProps = { searchParams?: Query }
...
export default async function ProductListPage({ searchParams }: PageProps) {
  ...
  const buildUrl = (nextPage: number) => {
    ...
    return qs ? `/produit?${qs}` : '/produit'
  }

  return (
    <main id="main" className="max-w-7xl mx-auto px-4 pt-28 pb-16">
