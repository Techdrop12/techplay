...
export default function LocaleError({
  ...
  useEffect(() => {
    if (process.env.NODE_ENV === 'development') console.error('[LocaleError]', error)
  }, [error])
  ...
  return (
    <main id="main" className="container-app mx-auto max-w-xl px-4 py-20 text-center" role="main" aria-labelledby="error-title">
      <div className="card p-8 shadow-[var(--shadow-lg)]">
        <h1 id="error-title" className="text-xl font-bold text-token-text sm:text-2xl">{t('title')}</h1>
