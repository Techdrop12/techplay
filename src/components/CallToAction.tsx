...
export default function CallToAction() {
  return (
    <section className="bg-black text-white py-16 px-6 text-center rounded-2xl mt-16">
      ...
      <Link href="/products" className="inline-block bg-[hsl(var(--surface))] text-[hsl(var(--text))] px-6 py-3 rounded-full text-sm font-medium border border-[hsl(var(--border))] hover:bg-[hsl(var(--surface-2))] transition">
