...
export default function CartItem({ item }: CartItemProps) {
  ...
  return (
    <motion.li
      ...
      className="flex items-center gap-4 p-4 border rounded-lg shadow-sm dark:border-zinc-700 bg-white dark:bg-gray-900"
      role="listitem"
    ...
    >
      ...
      <div className="flex-1 space-y-1">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400" aria-label={`Prix ${formatPrice(item.price)} euros multiplié par quantité ${item.quantity}`}>
      ...
      <button
        ...
        title={`Supprimer ${item.title} du panier`}
      >
