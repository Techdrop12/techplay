...
declare module '@sanity/client' {
  export interface SanityClient {
    fetch<T>(query: string, params?: Record<string, unknown>, options?: { next?: { revalidate?: number } }): Promise<T>
  }
...
declare module '@formkit/auto-animate/react' {
  ...
  export function useAutoAnimate<T extends HTMLElement>(): [RefObject<T | null>, (el: T | null) => void];
}
